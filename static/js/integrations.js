...
>
    ...
    methods: {
        ...
        handleEdit(data) {
            console.debug('golang editIntegration', data)
                ...
                response.json().then(
                    errorData => {
                        errorData.forEach(item => {
                            console.debug('golang item error', item)
        ...
        initialState: () => ({
            ...
            pluginName: 'security_scanner_golang',
...
register_component('GolangIntegration', GolangIntegration)
